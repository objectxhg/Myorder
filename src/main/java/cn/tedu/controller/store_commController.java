...
//		List<Map<String, Object>> list = service.listStore_commService(store_id);
	...
	@RequestMapping("/listStoreByName.do")
	@ResponseBody
	public JsonResult listStoreByNameController(String storeName){

		List<Map<String, Object>> list = service.listStoreByNameService(storeName);
